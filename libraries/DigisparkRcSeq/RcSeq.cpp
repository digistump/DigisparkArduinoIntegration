...
//========================================================================================================================
void RcSeq_DeclareCommandeEtSequence(uint8_t CmdIdx,uint8_t Pos,SequenceSt_t *Table, uint8_t SequenceLength)
{
...
//========================================================================================================================
uint8_t RcSeq_LanceSequence(SequenceSt_t *Table)
{
uint8_t Idx, Ret=0;
	for(Idx=0;Idx<SEQUENCE_MAX_NB;Idx++)
	{
