...
# If the include path is called DIGISPARK_DIR, we will assume we are
# targeting a digispark and modify what is necessary 
ifdef DIGISPARK_DIR
ARDUINO_DIR = $(DIGISPARK_DIR)
endif
...
ifdef DIGISPARK_DIR
ARDUINO_LIB_PATH  = $(ARDUINO_DIR)/libraries
ARDUINO_CORE_PATH = $(ARDUINO_DIR)/hardware/digispark/cores/tiny
ARDUINO_VAR_PATH  = $(ARDUINO_DIR)/hardware/digispark/variants
endif
...
ifdef DIGISPARK_DIR
BOARDS_TXT  = $(ARDUINO_DIR)/hardware/digispark/boards.txt
endif
endif
